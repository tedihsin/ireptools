...
header-includes:
  ...
  # labelwidth：ラベルの文字幅, leftmargin：リストの左余白・折り返し行の左側の余白, labelsep：ラベルと定義の間隔
  # itemsep：項目と項目の間隔, parsep：同じ項目内で段落を分けた時の空き
  - \usepackage{enumitem}
  - \setlist[description]{style=unboxed, labelwidth=5em, leftmargin=6em, labelsep=1em, itemsep=0.8\baselineskip, parsep=0pt}
  # ----------------------------------------------------------
