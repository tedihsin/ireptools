...
header-includes:
  ...
  # labelindent：ラベル左の余白, labelwidth：ラベルの文字幅, labelsep：ラベルと定義の間隔
  # leftmargin：リストの左余白・折り返し行の左側の余白, rightmargin：右側の余白
...
ggplot2::theme_set(
  ggplot2::theme_get() +
    ggplot2::theme(text = ggplot2::element_text(family = "Noto Sans CJK JP", size = 10))
)
